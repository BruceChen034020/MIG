...
c[6] = new Card("Dental caries / Dental cavity / Tooth\r\ndecay", 3, "Disease", 6);
...
c[14] = new Card("Killer T cell / Cytotoxic T lymphocyte\r\n/ Tc / CTL / Cytolytic T cell /\r\nCD8+ T-cell", 3, "Immunity", 14);
...
c[28] = new Card("Enterotoxigenic E. coli / ETEC / \r\nTraveler's diarrhea", 1, "Disease", 28);
...
c[35] = new Card("Clostridium botulinum (neurotoxin /\r\nBotox)", 4, "Pathogen", 35);
...
c[44] = new Card("Monocyte / Macrophage / Histiocyte / Microglia / Kupffer cell\r\n / Alveolar macrophage / Osteoclasts / Adipose tissue macrophages / \r\nSinus histiocytes / Langerhans cells / Hofbauer cells / \r\nIntraglomerular mesangial cells / Red pulp macrophages / Sinusoidal\r\n lining cells / LysoMac", 1, "Immunity", 44);
c[44].annotation = "3生效";
...
c[59] = new Card("Salmonella enterica Typhimurium\r\n(serotype)", 4, "Pathogen", 59);
c[60] = new Card("Salmonellosis", 1, "Disease", 60);
c[61] = new Card("Natural killer cell / NK cell / Large\r\ngranular lymphocyte", 2, "Immunity", 61);
c[61].annotation = "2生效";
...
c[66] = new Card("Enterohemorrhagic E. coli /\r\nHemorrhagic colitis", 3, "Disease", 66);
...
c[76] = new Card("Haemophilus influenzae type b / Hib\r\n(serotype)", 1, "Pathogen", 76);
c[77] = new Card("Otitis externa / Acute otitis\r\nexterna / Swimmer's ear", 2, "Disease", 77);
c[78] = new Card("Nose (Paranasal sinuses)", 3, "Organ", 78);
c[79] = new Card("Neisseria meningitidis W-135\r\n(serotype)", 4, "Pathogen", 79);
...
c[89] = new Card("Indigenous microbiota of the URT\r\n(opportunistic)", 2, "Pathogen", 89);
...
c[108] = new Card("Healthcare-acquired pneumonia\r\n(HCAP)", 1, "Disease", 108);
c[109] = new Card("Chlamydophila pneumoniae", 2, "Pathogen", 109);
c[110] = new Card("Community-acquired pneumonia\r\n(CAP)", 3, "Disease", 110);
...
c[120] = new Card("\"Atypical\" CAP / Walking\r\npneumonia ", 1, "Disease", 120);
c[121] = new Card("Legionnaires' disease /\r\nLegionellosis", 2, "Disease", 121);
...
c[129] = new Card("Epithelial cells joined by tight\r\njunctions", 2, "Immunity", 129);
...
c[136] = new Card("Pulmonary surfactant (Surfactant\r\nproteins SP-A)", 1, "Immunity", 136);
...
c[162] = new Card("Chlamydial urethritis / Chlamydia\r\n(Salpingitis / Pelvic inflammatory\r\ndisease / PID)", 3, "Disease", 162);
...
c[191] = new Card("Necrotizing fasciitis (NF) /\r\nFlesh-eating disease", 4, "Disease", 191);
for(i=0; i<=191; i++){

...
var turnStatus; // me 現在在幹嘛? 非 me 的 turn => null. null(not my turn), Nothing(未選牌), Attack(選了牌未攻擊), Discard(棄牌階段), Freeze(攻擊了別人等回應), Attacked(被攻擊做回應), Idu(以毒攻毒), Immune(免疫), Attacked2(被反攻), Immune+(是否使用 helper)
